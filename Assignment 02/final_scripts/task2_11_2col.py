...
ax = axes[0]
im = ax.imshow(np.real(psi), extent=[0, nSteps*dt/1e-2, x[0], x[-1]], aspect="auto")
...
ax = axes[1]
im = ax.imshow(np.imag(psi), extent=[0, nSteps*dt/1e-2, x[0], x[-1]], aspect="auto")
...
fig.savefig("report_2col/figs/box_deltaf.pdf", bbox_inches="tight", pad=0)
...
# plt.savefig("report_2col/figs/box_deltaf_prob.pdf", bbox_inches="tight", pad=0)
