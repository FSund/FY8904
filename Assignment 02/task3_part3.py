...
ax.set_xlabel(r"$\nu_0$")
# ax.set_ylabel(r"# of $\lambda_n < \nu_0$")
ax.set_ylabel(r"Eigenvalues below $\nu_0$")
ax.set_xlim([0, 1e3])
fig.tight_layout()
fig.savefig("report/figs/roots_all.pdf", bbox_inches="tight")

n_minimums = []
V0s = np.linspace(21.5, 23, 100)
for V0 in V0s:
    x, lambda_n, psi_n = eval(1001)
...
fig.tight_layout()
fig.savefig("report/figs/roots_details.pdf", bbox_inches="tight")
